...
export function PrivacyPolicy({ onBack }: PrivacyPolicyProps) {
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
            {/* Header */}
            <header className="sticky top-0 z-10 backdrop-blur-lg bg-slate-900/80 border-b border-white/10">
            ...
            <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
                ...
                {/* Last Updated */}
                <p className="text-sm text-gray-400">Last updated: December 30, 2025</p>

                {/* Introduction */}
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold text-purple-300">Welcome to DigiMark</h2>
                ...
                <section className="space-y-4 bg-white/5 rounded-2xl p-6">
                    ...
                    <div className="space-y-3 text-gray-300">
                        ...
                        <div className="pl-4 border-l-2 border-purple-500">
                            <h3 className="font-semibold text-white">Social Media Access Tokens</h3>
                            <p>OAuth tokens from LinkedIn, Twitter/X, Facebook, and Instagram to publish posts on your behalf.</p>
                        </div>
                        <div className="pl-4 border-l-2 border-purple-500">
                            <h3 className="font-semibold text-white">User-Generated Content</h3>
                ...
                <section className="space-y-4 bg-white/5 rounded-2xl p-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {['Facebook/Meta', 'LinkedIn', 'Twitter/X', 'Instagram', 'Google Firebase', 'Groq AI', 'Segmind AI'].map((service) => (
                            <div key={service} className="bg-white/10 rounded-lg px-3 py-2 text-sm text-center">
                                {service}
                            </div>
                        ))}
                    </div>
                ...
                <section id="data-deletion" className="space-y-4 bg-gradient-to-r from-red-900/30 to-purple-900/30 rounded-2xl p-6 border border-red-500/30">
                    ...
                    <div className="bg-black/30 rounded-xl p-4 space-y-3">
                        <h3 className="font-semibold text-white">How to Delete Your Data:</h3>
                ...
                {/* Contact Us */}
                <section className="space-y-4 bg-gradient-to-r from-purple-900/50 to-blue-900/50 rounded-2xl p-6">
                    <h2 className="text-xl font-bold text-purple-300 flex items-center gap-2">
                        📧 Contact Us
                    </h2>
                    <p className="text-gray-300">
                ...
                {/* Terms of Service */}
                <section id="terms" className="space-y-4 bg-white/5 rounded-2xl p-6">
                    <h2 className="text-xl font-bold text-purple-300">📜 Terms of Service</h2>
                    <p className="text-gray-300">
