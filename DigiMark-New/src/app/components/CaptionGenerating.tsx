...
interface CaptionGeneratingProps {
  onNavigate: (screen: string) => void;
}

export function CaptionGenerating({ onNavigate }: CaptionGeneratingProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Brain size={48} style={{ color: '#FFFFFF' }} />
        </div>
