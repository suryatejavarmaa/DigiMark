...
export function SchedulePicker({ onNavigate, onTimeSelect, returnScreen = 'schedule-preview', backScreen }: SchedulePickerProps) {
  const now = new Date();
    ...
    >
      ...
      >
        <div className="flex items-center gap-4">
          <button
            onClick={() => onNavigate(backScreen || (returnScreen === '' ? 'select-channels' : 'select-channels'))}
            style={{
              width: '40px',
              height: '40px',
              borderRadius: '12px',
