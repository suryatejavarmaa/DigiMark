import { ArrowLeft, Image as ImageIcon, RefreshCw, Loader2 } from 'lucide-react';
import { useState, useEffect } from 'react';
import { ImageWithFallback } from './figma/ImageWithFallback';
import { AIService } from '../../services/AIService';
import { UserService } from '../../services/UserService';

interface EditScheduledPostImageProps {
...
export function EditScheduledPostImage({ onNavigate, scheduleTime = '', onChangeSchedule, userId }: EditScheduledPostImageProps) {
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: '12px',
              overflow: 'hidden',
              boxShadow: '0 8px 24px rgba(131, 102, 255, 0.2)'
            }}
          >
            {/* Static Poster Image */}
            <ImageWithFallback
      ...
      >
        <button
          onClick={() => {
            ...
            onNavigate('detail-preview-image');
          }}
          style={{
            width: '100%',
            padding: '16px',
